...
export function actionProducts({ commit }) {
  return axios
    .get("https://api.laboutiquedelaflor.com.ar/api/products/activeProducts")
    .then(({ data }) => {
...
export function actionRelatedProductByCat({ commit }, catId) {
  return axios
    .get(
      `https://api.laboutiquedelaflor.com.ar/api/products/findForCategory/${catId}`
    )
    .then(({ data }) => {
...
export function actionRelatedProductBySubCat({ commit }, subCatId) {
  return axios
    .get(
      `https://api.laboutiquedelaflor.com.ar/api/products/findForSubcategory/${subCatId}`
    )
    .then(({ data }) => {
